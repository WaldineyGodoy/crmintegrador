commit 670c977e786db6b16400079478514bcc210ba5ca
Author: Waldiney Godoy <godoy@b2wenergia.com.br>
Date:   Mon Aug 31 07:31:32 2026 -0300

    docs: add task 3 report
...
index b1e14da..24e4f33 100644
--- a/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/progress.md
...
+
diff --git a/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-report.md b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-report.md
new file mode 100644
index 0000000..9700ca6
--- /dev/null
+++ b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-report.md
@@ -0,0 +1,39 @@
+# Task 2 Report
+
...
+## Issues or Concerns
+None.
diff --git a/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-review.md b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-review.md
new file mode 100644
index 0000000..23b48d8
--- /dev/null
+++ b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-2-review.md
@@ -0,0 +1,15278 @@
...
++  });
++});
diff --git a/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-brief.md b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-brief.md
new file mode 100644
index 0000000..60dc240
--- /dev/null
+++ b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-brief.md
@@ -0,0 +1,63 @@
+### Task 3: RLS (Row Level Security) Policies
+
+**Files:**
...
+git commit -m "feat: add RLS policies for strict marketplace isolation"
+```
diff --git a/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-report.md b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-report.md
new file mode 100644
index 0000000..9df704e
--- /dev/null
+++ b/.superpowers/sdd/2026-08-30-supabase-marketplace-integration/task-3-report.md
@@ -0,0 +1,43 @@
...
+None.
diff --git a/supabase/migrations/20260830000002_rls_policies.sql b/supabase/migrations/20260830000002_rls_policies.sql
new file mode 100644
index 0000000..2d7e853
--- /dev/null
+++ b/supabase/migrations/20260830000002_rls_policies.sql
@@ -0,0 +1,18 @@
+-- Instaladores podem ler os projetos onde estão designados
+CREATE POLICY "Installer can read assigned project"
+  ON public.projects FOR SELECT
...
+  ON public.profiles FOR SELECT
+  USING (role = 'Instalador');
diff --git a/tests/supabase_rls.test.js b/tests/supabase_rls.test.js
new file mode 100644
index 0000000..5d2217a
--- /dev/null
+++ b/tests/supabase_rls.test.js
@@ -0,0 +1,15 @@
+import { describe, it, expect } from 'vitest';
+import fs from 'fs';
+import path from 'path';
